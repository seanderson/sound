...
to set-voices
  sound:set-voice-instrument 0 "bass and lead"
  sound:set-voice-instrument 1 "polysynth"
  sound:set-voice-instrument 2 "sawtooth wave"
  sound:set-voice-instrument 3 "SITAR"
  ;; Configure the durations for each
  sound:set-voice-duration 0 4
