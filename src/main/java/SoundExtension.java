...
public class SoundExtension extends org.nlogo.api.DefaultClassManager {
    ...
    public void load(org.nlogo.api.PrimitiveManager primManager) {
        ...
        primManager.addPrimitive("rhythm", new Rhythm());
        ...
        primManager.addPrimitive("set-voice-loudness", new SetLoudness());
        ...
        primManager.addPrimitive("delete-drum", new DeleteDrum());
