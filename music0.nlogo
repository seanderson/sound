...
to init
  clear-all
  sound:init 4 ;; initialize for 4 voices
  sound:set-parameter "BPM" bpm
  set-rhythm1 ;; setup drums and a rhythm
  set-voices ;; setup instrument voices
end
...
to set-voices
  ...
  sound:set-voice-duration 0 16 ;; voice 0 is 16 time units long
  ...
  ;; Set default loudness for voices 2 and 3
...
to set-rhythm1
  ...
  sound:rhythm 9   "-46444604446046-" 0 4
  sound:rhythm 5   "----3-------8---" 0 4
  sound:rhythm 0   "8-------4-------" 0 4
  sound:set-drum 0 "MARACAS" ;; Custom drum for drum voice 0
end
...
import-file
import-file
"models/fourMeas1.csv" "models/fourMeas2.csv" "models/fourMeas3.csv" "models/fourMeas4.csv" "models/fourMeas5.csv"
0
...
This assumes a folder called "wav" in which are found files like "duh-0.wav", "duh-1.wav", etc.  These must correspond to the pitches in your chosen scale, currently the C pentatonic scale.

Full Documentation is at https://github.com/seanderson/sound/wiki
